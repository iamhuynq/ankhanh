...
<html lang="en">
  ...
  <body class="text-white">
    ...
    <div class="relative z-20">
      <div
        class="flex justify-between my-container absolute top-7 left-1/2 transform -translate-x-1/2 px-4 lg:px-0 z-10"
      >
        <img src="/public/images/logo.png" loading="lazy" class="w-36 md:w-auto"/>
        <div
          class="items-center justify-between uppercase w-1/2 hidden lg:flex"
        >
          <p class="cursor-pointer menu-item">Trang chủ</p>
          <p class="cursor-pointer menu-item" data-section="duan">360 dự án</p>
          <p class="cursor-pointer menu-item" data-section="tailieu">
            tài liệu
          </p>
          <p class="cursor-pointer menu-item" data-section="matbang">
            Mặt bằng dự án
          </p>
        </div>
        <button id="menu-btn" class="p-3 lg:hidden">
          <div class="h-0.5 w-6 bg-white"></div>
          <div class="h-0.5 w-6 bg-white my-1"></div>
          <div class="h-0.5 w-6 bg-white"></div>
        </button>
        <div
          class="absolute top-full left-0 w-full bg-[#005638] hidden shadow-lg p-4 uppercase"
          id="menu-down"
        >
          <p>Trang chủ</p>
          <p class="mt-1 menu-item" data-section="duan">360 dự án</p>
          <p class="mt-1 menu-item" data-section="tailieu">tài liệu</p>
          <p class="mt-1 menu-item" data-section="matbang">Mặt bằng dự án</p>
        </div>
      </div>
      <img
    ...
    <div class="section-2 bg-cover bg-no-repeat relative pb-20 z-10">
      <div
        class="lg:flex items-center justify-between 2xl:gap-14 -mt-8 2xl:-mt-14 overflow-hidden"
      >
        <div class="flex-1">
          <img
        ...
        <div class="flex-1 px-4 lg:px-0 md:pt-12">
          <div
          ...
          >
            ...
            />
            <p class="text-sm mt-8 w-full md:w-[90%] 2xl:lg:w-2/3">
          ...
          <div class="mt-8">
            ...
            >
              ...
              <p class="text-sm mt-1 w-full md:w-[90%] 2xl:w-2/3">
